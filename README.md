...
![Last DEV Commit](https://img.shields.io/endpoint?url=https://kartoza.github.io/kartoza-badges/data/devops-app_build_dev/dev-commit-tag.json)
![DEV Status](https://img.shields.io/endpoint?url=https://kartoza.github.io/kartoza-badges/data/devops-app_build_dev/dev-status.json)

Kartoza DevOps Testing web app badge test
=========================================

A simple web application for testing against changes within the Software Development Life Cycle (SDLC).
...
### 6. Access the app locally
 Go to the browser and access the app via this url:
 ```
 http://localhost:8501/
 ```
